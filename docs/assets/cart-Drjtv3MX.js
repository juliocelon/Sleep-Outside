import{l as m,a as l,r as g,s as y}from"./utils-x_2z0UIf.js";m();function s(){const t=l("so-cart");if(console.log("🛒 Cart items from localStorage:",t),!t||Array.isArray(t)&&t.length===0){document.querySelector(".product-list").innerHTML=`
      <li class="empty-cart">
